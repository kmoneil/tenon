...
const (
	...
	CodeDecodeLengthMismatch        Code = "decode.length_mismatch"
	CodeDecodeMarked                Code = "decode.marked"
	CodeDecodeNotKnown              Code = "decode.not_known"
	CodeDecodeNull                  Code = "decode.null"
	CodeDecodeOutOfRange            Code = "decode.out_of_range"
	CodeDecodeUnmarshalFailed       Code = "decode.unmarshal_failed"
